...
public class Draggable2D : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler 
{
    ...
    public void OnPointerClick(PointerEventData eventData) {
        // Pendant le mulligan
        if (GameManager.firstTurn && !FindAnyObjectByType<GameManager>().GO_HandWrap.GetComponent<HandDisplay>().clickValidMulligan) {
            GetComponent<CardDisplay>().ToggleMulliganSelect();
        }
    }
